...
from ..environment import Home, GroceryStore, Office, School, Hospital, RetailStore, HairSalon, Restaurant, Bar, Bus, \
...
small_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(Bus, num=4, num_assignees=4, state_opts=dict(visitor_capacity=30))   
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
...
tiny_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(Bus, num=1, num_assignees=1, state_opts=dict(visitor_capacity=30))  
    ],
    person_routine_assignment=DefaultPersonRoutineAssignment())
