...
from ..interfaces import LocationState, ContactRate, SimTime, SimTimeTuple, LocationRule, globals, BaseLocation, BusinessLocationState, BusinessBaseLocation
...
class Bus(BusinessBaseLocation[BusState]):
